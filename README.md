...
> - Lihat Repository projectRAW disini: https://github.com/Raraeva24/MSIBProjectRAW
...
## Lihat Repository ReCode#2 disini: https://github.com/Raraeva24/MSIBProject-ReCode_2.git sebagai bagian dari penyempurnaan project dan pengintegrasian Model AI Groq (Llama 3.1).
...
```bash
# 1. Clone repositori
git clone https://github.com/Raraeva24/MSIBProject_ReCode_1.git
